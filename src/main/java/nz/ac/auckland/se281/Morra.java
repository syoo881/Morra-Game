...
public class Morra {
  ...
  public void play() {
    // First check if the game has started, if name is null then game has not
    // started
    if (name == null) {
  ...
  public void showStats() {
    ...
    MessageCli.PRINT_PLAYER_WINS.printMessage(
        name, Integer.toString(humanWin), Integer.toString(pointsToWin - humanWin));
    MessageCli.PRINT_PLAYER_WINS.printMessage(
        "Jarvis", Integer.toString(aiWin), Integer.toString(pointsToWin - aiWin));
  }
  ...
  public void whoWon() {
    ...
    if ((currentFingers + aiFingers == currentSum) && (currentFingers + aiFingers != aiSum)) {
      ...
      if (humanWin == pointsToWin) {
        ...
        && (currentFingers + aiFingers != currentSum)) {
